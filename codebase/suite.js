...
(function (ComboboxEvent) {
    ComboboxEvent["change"] = "change";
    ComboboxEvent["open"] = "open";
    ComboboxEvent["close"] = "close";
})(ComboboxEvent = exports.ComboboxEvent || (exports.ComboboxEvent = {}));
var ComboState;
(function (ComboState) {
...
var Combobox = /** @class */ (function (_super) {
    ...
    Combobox.prototype._change = function () {
        var ids = this.list.selection.getId();
        this.events.fire(types_1.ComboboxEvent.change, [ids]);
        this.paint();
    };
    ...
    Combobox.prototype._showOptions = function () {
        ...
        if (this._configurePopup()) {
            this.events.fire(types_1.ComboboxEvent.open);
        }
    };
    ...
    Combobox.prototype._hideOptions = function () {
        ...
        this._popup.hide();
        this.paint();
        this.events.fire(types_1.ComboboxEvent.close);
    };
    ...
    Form.prototype._addLayoutItem = function (item) {
        ...
        switch (config.type) {
            ...
            case types_1.FormItemType.combo:
                ...
                combo.events.on(ts_combobox_1.ComboboxEvent.change, function (selected) {
...
var Select = /** @class */ (function (_super) {
    ...
    Select.prototype._draw = function () {
        ...
        return dom_1.el(".dhx_form-group", {
            ...
            this._drawLabel(),
            dom_1.el(".dhx_input-wrapper", {
                class: icon ? icon : "dxi dxi-chevron-down"
            }, [
                dom_1.el("select", {
                    id: id,
...
var SimpleVault = /** @class */ (function (_super) {
    ...
    SimpleVault.prototype._draw = function () {
        ...
        var files = this.data.getLength() ? dom_1.el("ul.dhx_simplevault__files.dhx_simplevault-files", this.data.map(function (file) { return dom_1.el("li.dhx_simplevault-files__item", [
            ...
            dom_1.el(".dhx_simplevault-files__delete.dhx_button--icon.dhx_button--view_link.dhx_button--size_small.dhx_button--color_secondary.dhx_button--circle", {
                dhx_id: file.id,
